...
import { getEventAvailability } from "@/app/actions/availability";
...
export default async function EventBookingPage({ params }) {
  ...
  const event = await getEventDetails(params.username, params.events);
  const availability = await getEventAvailability(params.events);
